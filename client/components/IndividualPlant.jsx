...
const IndividualPlant = () => {
  return (
    <div className="individ-plant-main">
      <h2 className="commonName">Common Name</h2>
      <h3 className="spciesName">species_name</h3>
      ...
      <div className="careDetailWrapper">
        ...
        <div className="careDetail">
          ...
          <p>
            ...
            consectetur, adipisicing elit. Praesentium inventore sunt facere
            saepe ratione numquam dicta aut qui voluptatem cupiditate adipisci,
            nesciunt debitis? Quo aspernatur ut aperiam obcaecati odio ea.
          </p>
          <ul className="">
            <li>water</li>
            <li>light</li>
