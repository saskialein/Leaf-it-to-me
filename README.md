...
[ ] As an unregistered user I would like to be able to see a list of all of the plants on the homepage
[ ] As an unregistered user I would like to be able to search for a specific plant on the homepage
[ ] As an unregistered user I would like to click on a plant from the homepage & be re-directed to see it’s individual profile page
